export const ticketColumns = [
    ...
    },
    {
        ...
        cell: (info) => {
            ...
            const buttons =
                status === 'Pending' ? (
                    <button className="btn btn-sm btn-info text-light w-100">Take</button>
                ) : status === 'Assigned' ? (
                    ...
                    <button className="btn btn-sm btn-primary text-light w-100 ">Reopen</button>
                ) : (
                    ''
                )
        ...
        cell: () => {
            return (
                <div className="d-flex gap-1 justify-content-center text-nowrap">
                    <button className="btn btn-success btn-sm text-light">VIEW</button>
                    ...
                    <button className="btn btn-warning btn-sm text-light">CHANGE ROLE</button>
                </div>
            )
        }
    }
